...
public class PersonIdTypeTest {
    //Se valida o prueba un dato nulo
    @Test
    @DisplayName("Null personIdType should throw an error")
    void null_person_idType_tests(){
